...
<script>
    $(function () {
        $("#like").click(function () {
            alert("글번호 : " +  ${info.no})
                $.ajax({
                    url: '${pageContext.request.contextPath}/evaluation.do?cmd=evaluation',
                    type: 'POST',
                    data: {"no" : ${info.no}, "eval" : 'like'},
